...
public class BlockBluestoneTorch extends BlockTorch {
	...
	public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
		...
		while (list != null && !list.isEmpty()
				&& p_149674_1_.getTotalWorldTime() - ((BlockBluestoneTorch.Toggle) list.get(0)).field_150844_d > 60L) {
			list.remove(0);
		}

		if (this.field_150113_a) {
			if (flag) {
				p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, BluestoneBlocks.unlit_bluestone_torch,
			...
			p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, BluestoneBlocks.bluestone_torch,
					p_149674_1_.getBlockMetadata(p_149674_2_, p_149674_3_, p_149674_4_), 3);
		}
	}
	...
	public boolean isAssociatedBlock(Block p_149667_1_) {
		return p_149667_1_ == BluestoneBlocks.unlit_bluestone_torch || p_149667_1_ == BluestoneBlocks.bluestone_torch;
	}
