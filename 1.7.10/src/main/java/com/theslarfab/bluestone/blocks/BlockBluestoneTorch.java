package com.zsolqrmods.bluestone.blocks;
...
import com.zsolqrmods.bluestone.Bluestone;
...
public class BlockBluestoneTorch extends BlockTorch
{
    ...
    private boolean func_150111_a(World p_150111_1_, int p_150111_2_, int p_150111_3_, int p_150111_4_, boolean p_150111_5_)
    {
        ...
        if (p_150111_5_)
        {
            list.add(new BlockBluestoneTorch.Toggle(p_150111_2_, p_150111_3_, p_150111_4_, p_150111_1_.getTotalWorldTime()));
        }
    ...
    public BlockBluestoneTorch(boolean p_i45423_1_)
    {
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        ...
        while (list != null && !list.isEmpty() && p_149674_1_.getTotalWorldTime() - ((BlockBluestoneTorch.Toggle)list.get(0)).field_150844_d > 60L)
        {
            list.remove(0);
        }
        ...
        if (this.field_150113_a)
        {
            if (flag)
            {
                p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, Bluestone.unlit_bluestone_torch, p_149674_1_.getBlockMetadata(p_149674_2_, p_149674_3_, p_149674_4_), 3);
        ...
        {
            p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, Bluestone.bluestone_torch, p_149674_1_.getBlockMetadata(p_149674_2_, p_149674_3_, p_149674_4_), 3);
        }
    }
    ...
    {
        return Item.getItemFromBlock(Bluestone.bluestone_torch);
    }
    ...
    {
        return p_149667_1_ == Bluestone.unlit_bluestone_torch || p_149667_1_ == Bluestone.bluestone_torch;
    }
