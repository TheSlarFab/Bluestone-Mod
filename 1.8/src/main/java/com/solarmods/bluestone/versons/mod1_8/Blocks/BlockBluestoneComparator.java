...
public class BlockBluestoneComparator extends BlockBluestoneDiode implements ITileEntityProvider
	{
	    ...
	    public static final PropertyEnum MODE = PropertyEnum.create("mode", BlockBluestoneComparator.Mode.class);
	    private static final String __OBFID = "CL_00000220";

	    public BlockBluestoneComparator(boolean powered)
	    {
	        super(powered);
	    ...
	    protected IBlockState getPoweredState(IBlockState unpoweredState)
	    {
	        ...
	        BlockBluestoneComparator.Mode mode = (BlockBluestoneComparator.Mode)unpoweredState.getValue(MODE);
	        EnumFacing enumfacing = (EnumFacing)unpoweredState.getValue(FACING);
	        return BluestoneBlocks.blockBluestoneComparatorOn.getDefaultState().withProperty(FACING, enumfacing).withProperty(POWERED, obool).withProperty(MODE, mode);
	    }

	    protected IBlockState getUnpoweredState(IBlockState poweredState)
	    {
	        Boolean obool = (Boolean)poweredState.getValue(POWERED);
	        BlockBluestoneComparator.Mode mode = (BlockBluestoneComparator.Mode)poweredState.getValue(MODE);
	        EnumFacing enumfacing = (EnumFacing)poweredState.getValue(FACING);
	        return BluestoneBlocks.blockBluestoneComparatorOff.getDefaultState().withProperty(FACING, enumfacing).withProperty(POWERED, obool).withProperty(MODE, mode);
	    }
	    ...
	    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
	    {
	        ...
	        else
	        {
	            ...
	            worldIn.playSoundEffect((double)pos.getX() + 0.5D, (double)pos.getY() + 0.5D, (double)pos.getZ() + 0.5D, "random.click", 0.3F, state.getValue(MODE) == BlockBluestoneComparator.Mode.SUBTRACT ? 0.55F : 0.5F);
	    ...
	    private void onStateChange(World worldIn, BlockPos pos, IBlockState state)
	    {
	        ...
	        {
	            TileEntityBluestoneComparator tileentitycomparator = (TileEntityBluestoneComparator)tileentity;
