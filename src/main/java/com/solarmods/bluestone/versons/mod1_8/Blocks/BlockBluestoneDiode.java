...
public abstract class BlockBluestoneDiode extends BlockDirectional{
    ...
    protected int calculateInputStrength(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        else
        {
            ...
            return Math.max(i, iblockstate1.getBlock() == BluestoneBlocks.blockBluestoneWire ? ((Integer)iblockstate1.getValue(BlockBluestoneWire.POWER)).intValue() : 0);
        }
    }
    ...
    protected int getPowerOnSide(IBlockAccess worldIn, BlockPos pos, EnumFacing side)
    {
        ...
        return this.canPowerSide(block) ? (block == BluestoneBlocks.blockBluestoneWire ? ((Integer)iblockstate.getValue(BlockBluestoneWire.POWER)).intValue() : worldIn.getStrongPower(pos, side)) : 0;
    }
    ...
    {
        return BluestoneBlocks.blockBluestoneRepeaterOff.isAssociatedBlock(blockIn) || Blocks.unpowered_comparator.isAssociated(blockIn);
    }
