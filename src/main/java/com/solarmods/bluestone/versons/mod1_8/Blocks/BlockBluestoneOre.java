...
public class BlockBluestoneOre extends Block {
    ...
    public BlockBluestoneOre(boolean isOn)
    {
        super(Material.rock);
    ...
    private void activate(World worldIn, BlockPos pos)
    {
        ...
        if (this == BluestoneBlocks.blockBluestoneOreUnlit)
        {
            worldIn.setBlockState(pos, BluestoneBlocks.blockBluestoneOreLit.getDefaultState());
        }
    }

    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        if (this == BluestoneBlocks.blockBluestoneOreLit)
        {
            worldIn.setBlockState(pos, BluestoneBlocks.blockBluestoneOreUnlit.getDefaultState());
        }
    }
    ...
    private void spawnParticles(World worldIn, BlockPos pos)
    {
        ...
        for (int i = 0; i < 6; ++i)
        {
            ...
            {
                worldIn.spawnParticle(EnumParticleTypes.REDSTONE, d1, d2, d3, 1.0D, 1.0D, 250.0D, new int[0]);
            }
        }
    }
    ...
    {
        return new ItemStack(BluestoneBlocks.blockBluestoneOreUnlit);
    }
}
