...
public class BlockBluestoneRailPowered extends BlockRailBase {
    ...
    protected BlockBluestoneRailPowered()
    {
        super(true);
    ...
    protected boolean func_176566_a(World worldIn, BlockPos pos, IBlockState state, boolean p_176566_4_, int p_176566_5_)
    {
        ...
        else
        {
            ...
            switch (BlockBluestoneRailPowered.SwitchEnumRailDirection.DIRECTION_LOOKUP[enumraildirection.ordinal()])
            {
                case 1:
                    if (p_176566_4_)
                    {
