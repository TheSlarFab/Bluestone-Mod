...
public class BlockBluestoneRepeater extends BlockBluestoneDiode {
    ...
    protected BlockBluestoneRepeater(boolean powered)
    {
        super(powered);
    ...
    protected IBlockState getPoweredState(IBlockState unpoweredState)
    {
        ...
        return BluestoneBlocks.blockBluestoneRepeaterOn.getDefaultState().withProperty(FACING, enumfacing).withProperty(DELAY, integer).withProperty(LOCKED, obool);
    }
    ...
    protected IBlockState getUnpoweredState(IBlockState poweredState)
    {
        ...
        return BluestoneBlocks.blockBluestoneRepeaterOff.getDefaultState().withProperty(FACING, enumfacing).withProperty(DELAY, integer).withProperty(LOCKED, obool);
    }
